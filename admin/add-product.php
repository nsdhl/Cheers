...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  try {
    ...
    $query = mysqli_query($mysqli, "INSERT INTO products (name,photo,description,price,stock,isActive,category) values ('$name','$photo','$description','$price','$stock','$isActive','$category')");
  } catch (Exception $e) {
...
<head>
  ...
  <title>Cheers | Add new Product</title>
